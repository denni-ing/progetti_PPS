...
public:
  ...
  bool Register(int student_id, const std::deque<Student>& all_students) {
...
std::deque<Student> ReadStudentFromFile(const std::string& filename){
  std::deque<Student> all_students;
